...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','ro.toshi.ti.mod.twilioipmessaging.js')
...
""" % module_assets
	...
	assets_router = os.path.join(cwd,'Classes','RoToshiTiModTwilioipmessagingModuleAssets.m')
